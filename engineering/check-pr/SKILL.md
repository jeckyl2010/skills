---
name: check-pr
description: Check a GitHub, GitLab, or Perforce PR/MR/CL for unresolved review comments, failing checks, and description gaps.
version: "1.2.0"
tags: [git, github, gitlab, perforce, code-review, pr, ci]
tool_agnostic: true
authors: [greptileai]
---
