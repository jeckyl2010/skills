---
name: greploop
description: Iteratively improve a PR/MR/CL until Greptile gives 5/5 confidence with zero unresolved comments. Max 5 iterations.
version: "1.2.0"
tags: [git, github, gitlab, perforce, greptile, code-review, automation]
tool_agnostic: true
authors: [greptileai]
---

<!-- License: MIT | Source: greptileai -->
